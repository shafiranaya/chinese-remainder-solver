        ...
        <div className="container-sm">
          ...
          <Accordion>
            ...
            <AccordionDetails>
              <Typography>
                <Typography>
                  Misalkan m<sub>1</sub>, m<sub>1</sub>, ..., m<sub>n</sub>{' '}
                  adalah bilangan bulat positif sedemikian sehingga PBB(m
                  <sub>i</sub>,m
                ...
                <br></br>
                <Typography>
                  Secara umum, solusi sistem kekongruenan linier adalah
                  berbentuk
                </Typography>
                <Typography>
          ...
          <Accordion>
            ...
            <AccordionDetails>
              <Typography>
                <Typography>
                  Dari persamaan modulo di atas, diketahui:
                </Typography>
            ...
            <AccordionDetails>
              <Typography>
                <Typography>
                  ...
                  positif terkecil yang memenuhi adalah{' '}
          ...
          <Accordion>
            ...
            <AccordionDetails>
              <Typography>
                ...
                <Coprime arrayOfEquation={this.props.arrayOfEquation} />
                <Typography>
                  Karena tidak semua coprime (PBB-nya = 1), maka persamaan di
                  atas tidak dapat diselesaikan menggunakan Chinese Reminder
                  Theorem.
                </Typography>
              </Typography>
            </AccordionDetails>
